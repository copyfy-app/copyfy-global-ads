...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our best-performing COD affiliate markets include Brazil, India, UAE, Mexico, Thailand, Egypt, Philippines, Malaysia, and over 90 countries. We provide localized copy that respects cultural preferences and local Google Ads regulations."
    },
    {
    ...
    },
    {
      ...
      answer: "COD affiliates using Copyfy report an average 340% improvement in conversion rates and 450% increase in ROI. Most affiliates see significant commission increases within the first 30 days of using our platform."
    },
    {
