        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center font-bold text-black relative">
                {testimonial.avatar}
                <span className="absolute -top-1 -right-1 text-lg">{testimonial.flag}</span>
              </div>
              <div>
